...
extern void *memset(void *arg_0x402a4220, int arg_0x402a4378, size_t arg_0x402a4510);
#line 61
extern void *memset(void *arg_0x402b2118, int arg_0x402b2270, size_t arg_0x402b2408);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x402cf820);
  ...
  void (**_sig_func)(int arg_0x402d2e90);
...
struct adc12_t;
# 71 "/opt/msp430-z1/msp430/include/msp430/common.h" 3
...
static inline void initSPlugCfgMsg(splug_cfg_msg_t *cfg);
...
typedef T32khz MeterC__BusyWait__precision_tag;
typedef uint16_t MeterC__BusyWait__size_type;
typedef TMilli MeterC__DataTimer__precision_tag;
...
typedef T32khz /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__precision_tag;
typedef uint16_t /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__size_type;
typedef /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__precision_tag /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__BusyWait__precision_tag;
typedef /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__size_type /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__BusyWait__size_type;
typedef /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__precision_tag /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__Counter__precision_tag;
typedef /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__size_type /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__Counter__size_type;
...
static void MeterC__CC2420Config__syncDone(error_t error);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void MeterC__AMControl__startDone(error_t error);
#line 117
static void MeterC__AMControl__stopDone(error_t error);
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void MeterC__Boot__booted(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void MeterC__AMSend__sendDone(
#line 92
message_t * msg, 
...
static void MeterC__DataTimer__fired(void );
...
# 56 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Packet.nc"
...
#line 47
static uint8_t CC2420PacketP__CC2420Packet__getPower(message_t *p_msg);
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 71 "/opt/tinyos-2.1.1/tos/lib/timer/Counter.nc"
static void /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__Counter__overflow(void );
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
# 59 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Config.nc"
static void MeterC__CC2420Config__setChannel(uint8_t channel);
#line 52
static error_t MeterC__CC2420Config__sync(void );





static uint8_t MeterC__CC2420Config__getChannel(void );
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t MeterC__AMControl__start(void );
...
uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t MeterC__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static void MeterC__CC2420Packet__setPower(message_t *p_msg, uint8_t power);
#line 47
static uint8_t MeterC__CC2420Packet__getPower(message_t *p_msg);
# 48 "/opt/tinyos-2.1.1/tos/interfaces/PacketAcknowledgements.nc"
static error_t MeterC__ACK__requestAck(
#line 42
message_t * msg);
#line 74
static bool MeterC__ACK__wasAcked(
#line 69
message_t * msg);
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void MeterC__DataTimer__startOneShot(uint32_t dt);
# 41 "/opt/tinyos-2.1.1/tos/interfaces/Random.nc"
static uint16_t MeterC__Random__rand16(void );
# 72 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void MeterC__Leds__led1Toggle(void );
# 5 "driver/SPlugControl.nc"
static error_t MeterC__SPlugControl__init(void );



static uint32_t MeterC__SPlugControl__read(uint8_t address);
#line 8
static error_t MeterC__SPlugControl__write(uint8_t address, uint32_t value);
#line 6
static void MeterC__SPlugControl__setState(uint8_t state);
# 25 "MeterC.nc"
uint8_t MeterC__count;
message_t MeterC__cfg_pkt;
splug_cfg_msg_t *MeterC__cfg;

message_t MeterC__data_pkt;
splug_data_msg_t *MeterC__data;

bool MeterC__lockRadio = FALSE;



static uint32_t MeterC__randomInterval(void );
...
static inline void MeterC__updateNewChannel(uint8_t channel);




static inline void MeterC__updateNewRfPower(uint8_t rfpower);




static inline void MeterC__sendDataMsg(void );
#line 66
static void MeterC__sendCfgMsg(void );
...
static inline void MeterC__setCfg(splug_cfg_msg_t *tmp);
#line 133
static inline void MeterC__Boot__booted(void );
#line 155
static inline void MeterC__AMControl__startDone(error_t err);
...
static inline void MeterC__DataTimer__fired(void );
...
static void MeterC__AMSend__sendDone(message_t *msg, error_t err);
#line 187
static inline message_t *MeterC__Receive__receive(message_t *bufPtr, void *payload, uint8_t len);
#line 209
static inline void MeterC__AMControl__stopDone(error_t err);

static inline void MeterC__CC2420Config__syncDone(error_t err);
# 35 "/opt/tinyos-2.1.1/tos/interfaces/GeneralIO.nc"
...
#line 31
static void SPlugP__SPlugControl__setState(uint8_t s);
#line 51
static error_t SPlugP__SPlugControl__write(uint8_t address, uint32_t value);
...
static uint32_t SPlugP__SPlugControl__read(uint8_t address);
# 24 "driver/spi/ADE7763P.nc"
#line 19
typedef struct ADE7763P____nesc_unnamed4310 {
...
enum /*Counter32khz32C.Transform*/TransformCounterC__0____nesc_unnamed4311 {
...
enum /*BusyWaitMicroC.BusyWaitCounterC*/BusyWaitCounterC__0____nesc_unnamed4312 {
...
#line 89
typedef enum CC2420TransmitP____nesc_unnamed4332 {
...
enum CC2420TransmitP____nesc_unnamed4333 {
...
#line 89
#line 81
typedef enum CC2420ReceiveP____nesc_unnamed4335 {
...
static inline uint8_t CC2420PacketP__CC2420Packet__getPower(message_t *p_msg);
#line 98
static uint8_t CC2420PacketP__CC2420Packet__getNetwork(message_t *p_msg);
...
enum /*CounterMilli32C.Transform*/TransformCounterC__1____nesc_unnamed4337 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC__1____nesc_unnamed4338 {
...
enum UniqueSendP____nesc_unnamed4343 {
  UniqueSendP__S_IDLE, 
...
#line 56
struct UniqueReceiveP____nesc_unnamed4344 {
  am_addr_t source;
  uint8_t dsn;
...
enum UniqueReceiveP____nesc_unnamed4345 {
...
enum CC2420TinyosNetworkP____nesc_unnamed4346 {
#line 148
...
# 39 "/opt/tinyos-2.1.1/tos/system/FcfsResourceQueueC.nc"
enum /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC__0____nesc_unnamed4348 {
#line 39
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static error_t /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 47 "/opt/tinyos-2.1.1/tos/lib/timer/BusyWaitCounterC.nc"
enum /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1____nesc_unnamed4352 {

  BusyWaitCounterC__1__HALF_MAX_SIZE_TYPE = (/*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__size_type )1 << (8 * sizeof(/*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__size_type ) - 1)
};
#line 72
static inline void /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__Counter__overflow(void );
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x406624b0){
#line 28
  switch (arg_0x406624b0) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x406624b0);
#line 28
      break;
#line 28
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA0*/Msp430TimerCapComP__0____nesc_unnamed4353 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA1*/Msp430TimerCapComP__1____nesc_unnamed4354 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA2*/Msp430TimerCapComP__2____nesc_unnamed4355 {
#line 47
    uint16_t f;
#line 47
...
#line 71
  /*BusyWait32khzC.BusyWaitCounterC*/BusyWaitCounterC__1__Counter__overflow();
#line 71
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB0*/Msp430TimerCapComP__3____nesc_unnamed4356 {
#line 47
    uint16_t f;
#line 47
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x410154b8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x410154b8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40c1c220){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40c1c220) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40c1c220);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40c1cc70){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40c1cc70);
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40d17cf8){
#line 49
  switch (arg_0x40d17cf8) {
#line 49
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40d17cf8);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40cea948){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40cea948);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40c1c220){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40c1c220);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x40cea948){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x40cea948);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40c1c220){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40c1c220);
#line 78
      break;
#line 78
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40d17cf8){
#line 55
  switch (arg_0x40d17cf8) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40d17cf8);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40c1c220){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40c1c220);
#line 110
      break;
#line 110
    }
...
#line 281
  {
    ...
    switch (CC2420TransmitP__m_state) {
        ...
        if (CC2420TransmitP__PacketTimeSyncOffset__isSet(CC2420TransmitP__m_msg)) {
            ...
            (__nesc_temp50 = (*timesync).data, __nesc_hton_uint32(__nesc_temp50, __nesc_ntoh_uint32(__nesc_temp50) - time32));
            ...
            (__nesc_temp51 = (*timesync).data, __nesc_hton_uint32(__nesc_temp51, __nesc_ntoh_uint32(__nesc_temp51) + time32));
          }
...
#line 54
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  MeterC__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x410976a8, message_t * msg, error_t error){
#line 89
  switch (arg_0x410976a8) {
#line 89
    case 0U:
#line 89
      /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x410976a8, msg, error);
#line 89
      break;
#line 89
    }
...
# 72 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void MeterC__Leds__led1Toggle(void ){
#line 72
...
inline static bool MeterC__ACK__wasAcked(message_t * msg){
#line 74
  unsigned char __nesc_result;
#line 74
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
inline static void /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x410960a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x410960a0, addr, msg, len);
#line 69
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41016e20, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41016e20, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x410154b8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x410154b8, msg);
#line 95
}
#line 95
...
#line 134
  ...
  (__nesc_temp48 = header->fcf.data, __nesc_hton_leuint16(__nesc_temp48, __nesc_ntoh_leuint16(__nesc_temp48) & (1 << IEEE154_FCF_ACK_REQ)));

  (__nesc_temp49 = header->fcf.data, __nesc_hton_leuint16(__nesc_temp49, __nesc_ntoh_leuint16(__nesc_temp49) | ((((IEEE154_TYPE_DATA << IEEE154_FCF_FRAME_TYPE) | (
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x40fec628){
#line 92
  switch (arg_0x40fec628) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x40fec628);
#line 92
      break;
#line 92
    }
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t MeterC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
#line 69
# 9 "driver/SPlugControl.nc"
inline static uint32_t MeterC__SPlugControl__read(uint8_t address){
#line 9
  unsigned long __nesc_result;
#line 9
...
#line 54
{
  if (MeterC__lockRadio) {
    return;
    }
  __nesc_hton_uint8(MeterC__data->seq_no.data, (__nesc_ntoh_uint8(MeterC__data->seq_no.data) + 1) % 0xFF);
  __nesc_hton_uint32(MeterC__data->read_val1.data, MeterC__SPlugControl__read(__nesc_ntoh_uint8(MeterC__cfg->read_reg1.data)));
  __nesc_hton_uint32(MeterC__data->read_val2.data, MeterC__SPlugControl__read(__nesc_ntoh_uint8(MeterC__cfg->read_reg2.data)));

  if (MeterC__AMSend__send(__nesc_ntoh_uint16(MeterC__cfg->baserx_id.data), &MeterC__data_pkt, sizeof(splug_data_msg_t )) == SUCCESS) {
    MeterC__lockRadio = TRUE;
    }
}

# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void MeterC__DataTimer__startOneShot(uint32_t dt){
#line 62
...
#line 164
{
  MeterC__DataTimer__startOneShot(MeterC__randomInterval());

  if (__nesc_ntoh_uint8(MeterC__cfg->status.data) & 0x08) {
    { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 168
      MeterC__sendDataMsg();
#line 168
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40f379f0){
#line 72
  switch (arg_0x40f379f0) {
#line 72
    case 1U:
#line 72
      MeterC__DataTimer__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40f379f0);
#line 72
      break;
#line 72
    }
...
# 41 "/opt/tinyos-2.1.1/tos/interfaces/Random.nc"
inline static uint16_t MeterC__Random__rand16(void ){
#line 41
  unsigned int __nesc_result;
#line 41
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x41018490, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x41018490, msg, payload, len);
#line 67
...
# 6 "driver/SPlugControl.nc"
inline static void MeterC__SPlugControl__setState(uint8_t state){
#line 6
...
inline static error_t MeterC__SPlugControl__write(uint8_t address, uint32_t value){
#line 8
  unsigned char __nesc_result;
#line 8

#line 8
  __nesc_result = SPlugP__SPlugControl__write(address, value);
#line 8
...
#line 8
# 86 "/opt/tinyos-2.1.1/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline uint8_t CC2420PacketP__CC2420Packet__getPower(message_t *p_msg)
#line 86
{
  return __nesc_ntoh_uint8(CC2420PacketP__CC2420PacketBody__getMetadata(p_msg)->tx_power.data);
}

# 47 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static uint8_t MeterC__CC2420Packet__getPower(message_t *p_msg){
#line 47
  unsigned char __nesc_result;
#line 47

#line 47
  __nesc_result = CC2420PacketP__CC2420Packet__getPower(p_msg);
#line 47
...
inline static void MeterC__CC2420Packet__setPower(message_t *p_msg, uint8_t power){
#line 56
...
#line 49
{
  MeterC__CC2420Packet__setPower(&MeterC__cfg_pkt, rfpower);
  MeterC__CC2420Packet__setPower(&MeterC__data_pkt, rfpower);
}

# 271 "/opt/tinyos-2.1.1/tos/chips/cc2420/control/CC2420ControlP.nc"
static inline uint8_t CC2420ControlP__CC2420Config__getChannel(void )
#line 271
{
  /* atomic removed: atomic calls only */
...
# 58 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Config.nc"
inline static uint8_t MeterC__CC2420Config__getChannel(void ){
#line 58
  unsigned char __nesc_result;
#line 58
...
#line 58
#line 52
inline static error_t MeterC__CC2420Config__sync(void ){
#line 52
  unsigned char __nesc_result;
#line 52
...
#line 52
# 275 "/opt/tinyos-2.1.1/tos/chips/cc2420/control/CC2420ControlP.nc"
static inline void CC2420ControlP__CC2420Config__setChannel(uint8_t channel)
#line 275
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 59 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Config.nc"
inline static void MeterC__CC2420Config__setChannel(uint8_t channel){
#line 59
...
#line 44
{
  MeterC__CC2420Config__setChannel(channel);
  MeterC__CC2420Config__sync();
}
...
#line 78
  __nesc_hton_uint16(MeterC__cfg->baserx_id.data, __nesc_ntoh_uint16(tmp->baserx_id.data));


  if (__nesc_ntoh_uint16(tmp->interval_upper.data) >= __nesc_ntoh_uint16(tmp->interval_lower.data) && __nesc_ntoh_uint16(
  tmp->interval_lower.data) >= 10) {
      __nesc_hton_uint16(MeterC__cfg->interval_lower.data, __nesc_ntoh_uint16(tmp->interval_lower.data));
      __nesc_hton_uint16(MeterC__cfg->interval_upper.data, __nesc_ntoh_uint16(tmp->interval_upper.data));
    }


  if (__nesc_ntoh_uint8(tmp->channel.data) >= 11 && __nesc_ntoh_uint8(tmp->channel.data) <= 26 && __nesc_ntoh_uint8(
  tmp->channel.data) != MeterC__CC2420Config__getChannel()) {
      MeterC__updateNewChannel(__nesc_ntoh_uint8(tmp->channel.data));
      __nesc_hton_uint8(MeterC__cfg->channel.data, MeterC__CC2420Config__getChannel());
    }


  if (__nesc_ntoh_uint8(tmp->rfpower.data) >= 1 && __nesc_ntoh_uint8(tmp->rfpower.data) <= 31 && __nesc_ntoh_uint8(
  tmp->rfpower.data) != MeterC__CC2420Packet__getPower(&MeterC__data_pkt)) {
      MeterC__updateNewRfPower(__nesc_ntoh_uint8(tmp->rfpower.data));
      __nesc_hton_uint8(MeterC__cfg->rfpower.data, MeterC__CC2420Packet__getPower(&MeterC__data_pkt));
    }


  if (__nesc_ntoh_uint8(tmp->read_reg1.data) <= 0x3F) {
    __nesc_hton_uint8(MeterC__cfg->read_reg1.data, __nesc_ntoh_uint8(tmp->read_reg1.data));
    }
#line 104
  if (__nesc_ntoh_uint8(tmp->read_reg2.data) <= 0x3F) {
    __nesc_hton_uint8(MeterC__cfg->read_reg2.data, __nesc_ntoh_uint8(tmp->read_reg2.data));
    }

  if (__nesc_ntoh_uint8(tmp->write_reg.data) <= 0x3F) {
      MeterC__SPlugControl__write(__nesc_ntoh_uint8(tmp->write_reg.data), (uint32_t )__nesc_ntoh_uint16(tmp->write_val.data));
      __nesc_hton_uint8(MeterC__cfg->write_reg.data, __nesc_ntoh_uint8(tmp->write_reg.data));
      __nesc_hton_uint16(MeterC__cfg->write_val.data, __nesc_ntoh_uint16(tmp->write_val.data));
    }


  if (__nesc_ntoh_uint8(tmp->status.data) & 0x08) {
    (__nesc_temp44 = MeterC__cfg->status.data, __nesc_hton_uint8(__nesc_temp44, __nesc_ntoh_uint8(__nesc_temp44) | 0x08));
    }
  else {
#line 118
    (__nesc_temp45 = MeterC__cfg->status.data, __nesc_hton_uint8(__nesc_temp45, __nesc_ntoh_uint8(__nesc_temp45) & ~0x08));
    }

  if (__nesc_ntoh_uint8(tmp->status.data) & 0x04) {
      MeterC__SPlugControl__setState(SPLUG_ON_STATE);
      (__nesc_temp46 = MeterC__cfg->status.data, __nesc_hton_uint8(__nesc_temp46, __nesc_ntoh_uint8(__nesc_temp46) | 0x04));
    }
  else {
      MeterC__SPlugControl__setState(SPLUG_OFF_STATE);
      (__nesc_temp47 = MeterC__cfg->status.data, __nesc_hton_uint8(__nesc_temp47, __nesc_ntoh_uint8(__nesc_temp47) & ~0x04));
    }
}
...
#line 191
        {
          if (__nesc_ntoh_uint16(tmp->sensor_id.data) != TOS_NODE_ID) 
            {
...
#line 195
            if (__nesc_ntoh_uint8(tmp->status.data) & 0x01) {
                if (__nesc_ntoh_uint8(tmp->status.data) & 0x02) {
                  WDTCTL = 0;
                  }
                else {
#line 199
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x41019db8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x41019db8) {
#line 67
    case 123:
#line 67
      __nesc_result = MeterC__Receive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x41019db8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40c1f460){
#line 92
  switch (arg_0x40c1f460) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40c1f460);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40cede78){
#line 92
  switch (arg_0x40cede78) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40cede78);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40c1d9f8, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40c1d9f8) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40c1d9f8, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40b8b010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40b8b010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40b8b010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x410154b8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x410154b8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40b8b010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40b8b010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40b8b010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40b8c558){
#line 92
  switch (arg_0x40b8c558) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40b8c558);
#line 92
      break;
#line 92
    }
...
#line 53
  MeterC__CC2420Config__syncDone(error);
#line 53
}
#line 53
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x410193f8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x410193f8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 117
  MeterC__AMControl__stopDone(error);
#line 117
}
#line 117
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t MeterC__AMControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 92
  MeterC__AMControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerB2*/Msp430TimerCapComP__5____nesc_unnamed4365 {
#line 46
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * MeterC__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 66
  (__nesc_temp52 = CC2420PacketP__CC2420PacketBody__getHeader(p_msg)->fcf.data, __nesc_hton_leuint16(__nesc_temp52, __nesc_ntoh_leuint16(__nesc_temp52) | (1 << IEEE154_FCF_ACK_REQ)));
  return SUCCESS;
}

# 48 "/opt/tinyos-2.1.1/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t MeterC__ACK__requestAck(message_t * msg){
#line 48
  unsigned char __nesc_result;
#line 48
...
#line 92
  __nesc_hton_uint16(cfg->sensor_id.data, TOS_NODE_ID);
  __nesc_hton_uint16(cfg->baserx_id.data, 90);
  __nesc_hton_uint16(cfg->interval_lower.data, 500);
  __nesc_hton_uint16(cfg->interval_upper.data, 500);
  __nesc_hton_uint8(cfg->channel.data, 26);
  __nesc_hton_uint8(cfg->rfpower.data, 31);
  __nesc_hton_uint8(cfg->read_reg1.data, 0x26);
  __nesc_hton_uint8(cfg->read_reg2.data, 0x17);
  __nesc_hton_uint8(cfg->write_reg.data, 0x3D);
  __nesc_hton_uint16(cfg->write_val.data, 0);
  (__nesc_temp42 = cfg->status.data, __nesc_hton_uint8(__nesc_temp42, __nesc_ntoh_uint8(__nesc_temp42) | 0x08));
  (__nesc_temp43 = cfg->status.data, __nesc_hton_uint8(__nesc_temp43, __nesc_ntoh_uint8(__nesc_temp43) | 0x04));
}
...
# 5 "driver/SPlugControl.nc"
inline static error_t MeterC__SPlugControl__init(void ){
#line 5
  unsigned char __nesc_result;
#line 5
...
#line 138
  ...
  MeterC__cfg = (splug_cfg_msg_t *)MeterC__Packet__getPayload(&MeterC__cfg_pkt, sizeof(splug_cfg_msg_t ));
  initSPlugCfgMsg(MeterC__cfg);
  MeterC__ACK__requestAck(&MeterC__cfg_pkt);
  MeterC__count = 0;

  MeterC__data = (splug_data_msg_t *)MeterC__Packet__getPayload(&MeterC__data_pkt, sizeof(splug_data_msg_t ));
  __nesc_hton_uint16(MeterC__data->sensor_id.data, TOS_NODE_ID);
  __nesc_hton_uint8(MeterC__data->seq_no.data, 0);
  __nesc_hton_uint32(MeterC__data->read_val1.data, 0);
  __nesc_hton_uint32(MeterC__data->read_val2.data, 0);

  MeterC__updateNewChannel(__nesc_ntoh_uint8(MeterC__cfg->channel.data));
  MeterC__updateNewRfPower(__nesc_ntoh_uint8(MeterC__cfg->rfpower.data));
}

# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
inline static void RealMainP__Boot__booted(void ){
#line 49
  MeterC__Boot__booted();
#line 49
}
#line 49
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40ce3758, uint8_t data){
#line 54
  switch (arg_0x40ce3758) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40ce3758, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x40ce2010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x40ce2010);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40ce3758){
#line 49
  switch (arg_0x40ce3758) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40ce3758);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x406624b0){
#line 28
  switch (arg_0x406624b0) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x406624b0);
#line 28
      break;
#line 28
    }
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x405a14a0){
#line 64
  switch (arg_0x405a14a0) {
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x405a14a0);
#line 64
      break;
#line 64
    }
...
#line 172
    {
      MeterC__lockRadio = FALSE;
      MeterC__Leds__led1Toggle();

      if (msg != &MeterC__cfg_pkt) {
        {
#line 177
          __nesc_atomic_end(__nesc_atomic); 
#line 177
      ...
      if ((err == SUCCESS && MeterC__ACK__wasAcked(msg)) || ++MeterC__count >= 10) {
        MeterC__count = 0;
        }
      else {
#line 183
...
#line 66
{
  ...
  if (MeterC__AMSend__send(__nesc_ntoh_uint16(MeterC__cfg->baserx_id.data), &MeterC__cfg_pkt, sizeof(splug_cfg_msg_t )) == SUCCESS) {
    MeterC__lockRadio = TRUE;
    }
}
...
#line 47
{
  /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 124);
  return /*MeterAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
...
#line 36
{
  uint32_t seed = MeterC__Random__rand16();
  uint32_t time = (__nesc_ntoh_uint16(MeterC__cfg->interval_upper.data) - __nesc_ntoh_uint16(MeterC__cfg->interval_lower.data)) * seed;

#line 39
  time >>= 15;
  time += __nesc_ntoh_uint16(MeterC__cfg->interval_lower.data);
  return time;
}
...
# 80 "/opt/tinyos-2.1.1/tos/chips/cc2420/packet/CC2420PacketP.nc"
static void CC2420PacketP__CC2420Packet__setPower(message_t *p_msg, uint8_t power)
#line 80
{
  if (power > 31) {
